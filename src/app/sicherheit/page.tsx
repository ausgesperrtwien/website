...
export const metadata: Metadata = {
  title: "Sicherheit",
  description:
    "Sicherheitsschlösser, Zylinder, Beschläge und Einbruchschutz von Magic Key. Wir installieren Produkte von EVVA, DOM, ABUS, dormakaba. Kostenlose Beratung.",
};
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <div>
              ...
              <p className="mt-4 max-w-lg text-lg text-white/80">
                Die Einbruchrate in Wien sollte man nicht unterschätzen. Magic
                Key hat sich auf hochwertige Sicherheitsprodukte spezialisiert,
