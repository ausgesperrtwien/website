...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://ausgesperrtwien.at/aufsperrdienst/schluessel-verloren",
  },
};
...
export default function SchluesselVerlorenPage() {
  ...
  return (
    <div className="pt-[72px]">
      ...
      <BezirkeLinkGrid
        title="Schlüssel verloren — Aufsperrdienst in Ihrem Bezirk"
        intro="Schlüssel in welchem Bezirk verloren? Wählen Sie Ihren Standort — wir öffnen sofort und beraten anschließend zum Zylindertausch."
        bg="white"
      />
